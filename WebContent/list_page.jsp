...
<c:if test="${not empty  user}">
	...
	<div class="listDIV">
		<table
			...
			<caption>学生列表 - 共${ pageBean.totalSize}人</caption>
			...
			<tbody>
				<c:forEach items="${pageBean.list}" var="s" varStatus="status">
					<tr>
						...
						<td><a href="#" onclick="javascript:return doDelete(${s.id})">
				...
				<tr>
					<td colspan="8">第 ${pageBean.currentPage } /
						...
						| <a
								href="StudentListServlet?currentPage=${pageBean.currentPage-1 }">上一页</a>
							...
							<a
								href="StudentListServlet?currentPage=${pageBean.currentPage+1 }">下一页</a> | 
